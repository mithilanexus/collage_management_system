        ...
        <Card className="border-destructive/20">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              We're having trouble loading your student information. This is usually temporary and should resolve shortly.
            </p>
            ...
            {process.env.NODE_ENV === 'development' && (
              <div className="bg-muted/50 rounded-lg p-4 mb-6 text-left">
                ...
                <pre className="text-xs text-muted-foreground overflow-auto max-h-32">
                  {error?.message || 'Unknown student portal error occurred'}
                </pre>
              </div>
            )}
            ...
            <div className="mt-6 pt-6 border-t border-border">
              <p className="text-xs text-muted-foreground">
                Need help with your courses or account?{" "}
                <a 
                  href="mailto:student.support@edutech.edu" 
