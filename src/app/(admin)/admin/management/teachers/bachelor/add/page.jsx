...
export default function AddBachelorTeacherPage() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("New Bachelor Teacher:", teacherData);
    toast.success("Bachelor teacher added successfully!");
  };
      ...
      <div className="flex items-center gap-4">
        <Link href="/admin/management/teachers/bachelor">
          <Button variant="outline" size="sm">
            ...
            Back to Bachelor Teachers
          </Button>
        </Link>
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground flex items-center gap-2">
            <GraduationCap className="w-8 h-8 text-purple-600" />
            Add Bachelor Level Teacher
          </h1>
          <p className="text-muted-foreground">
            Add a new professor or lecturer to the bachelor programs
          </p>
        </div>
      </div>
