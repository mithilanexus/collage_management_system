...
export default function EditBachelorSubject({ params }) {
  ...
  useEffect(() => {
    const loadSubjectData = () => {
      ...
      const mockSubject = {
        ...
        syllabus: "Basic programming constructs, data types, control structures, functions, arrays",
        status: "active"
      };

      const mockPrerequisites = ["Basic Mathematics", "Computer Literacy"];
      const mockOutcomes = [
        "Understand basic programming concepts",
        "Write simple programs using control structures",
        "Apply problem-solving techniques in programming"
      ];
      const mockAssessments = ["Midterm Exam", "Final Exam", "Assignments", "Lab Work"];

      setFormData(mockSubject);
      setPrerequisites(mockPrerequisites);
      setLearningOutcomes(mockOutcomes);
      setAssessmentMethods(mockAssessments);
      setLoading(false);
    };
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Updating bachelor subject:", subjectData);
    toast.success("Bachelor subject updated successfully!");
  };
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground flex items-center gap-2">
            ...
            Edit Bachelor Subject
          </h1>
          <p className="text-muted-foreground">
            Update subject information for bachelor level programs
          </p>
        </div>
      </div>
